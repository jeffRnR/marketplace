...
export default function NotificationBar() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {/* ── Dropdown ── */}
      {open && (
        <div className="absolute right-0 top-8 w-80 sm:w-96 bg-gray-900 border border-gray-700
          ...
          <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
            ...
            <div className="flex items-center gap-2">
              ...
              <button onClick={() => setOpen(false)} className="text-gray-600 hover:text-gray-400 transition">
                <X className="w-4 h-4" />
              </button>
            </div>
          </div>
                ...
                {unreadNotifs.length > 0 && (
                  <div>
                    ...
                    {unreadNotifs.map(notif => (
                      <NotifRow key={notif.id} notif={notif} onClick={() => handleClick(notif)} />
                    ))}
                  </div>
                )}
