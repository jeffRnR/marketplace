...
function Footer() {
  ...
  return (
    <footer className="w-full border-t-2 border-[var(--brand-purple)]/40 bg-[var(--surface-muted)] text-[var(--foreground)]">
      ...
      <div className="mx-auto w-full lg:w-[70%] px-4 pt-10 pb-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          ...
          {/* ── Col 2: Explore ── */}
          <div>
            <p className="text-[var(--foreground)] font-semibold text-sm mb-4 uppercase tracking-widest">Explore</p>
            <ul className="space-y-2.5">
              {[
                ...
                <li key={label}>
                  <Link href={href} className="text-[var(--muted)] text-sm hover:text-[var(--foreground)] transition duration-200">
                    {label}
                  </Link>
                </li>
              ))}
          ...
          {/* ── Col 3: Marketplace ── */}
          <div>
            <p className="text-[var(--foreground)] font-semibold text-sm mb-4 uppercase tracking-widest">Noizy Marketplace</p>
            <ul className="space-y-2.5">
              {[
          ...
          {/* ── Col 4: Contact ── */}
          <div>
            <p className="text-[var(--foreground)] font-semibold text-sm mb-4 uppercase tracking-widest">Get in Touch</p>
        ...
        {/* ── Bottom bar ── */}
        <div className="border-t-2 border-[var(--brand-purple)]/20 pt-5">
