          ...
          <div className="px-4 sm:px-6 pb-5 -mt-8 relative">
            <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-xl border-4 border-gray-900 bg-gray-800 overflow-hidden mb-3 flex items-center justify-center shadow-xl">
              {profile.logoImage
                ...
                : <Store className="w-7 h-7 sm:w-8 sm:h-8 text-purple-500" />
              }
            </div>
            <div className="flex flex-wrap items-start justify-between gap-2">
              <div className="min-w-0">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  {profile.isVerified && <BadgeCheck className="w-4 h-4 sm:w-5 sm:h-5 text-purple-500 shrink-0" />}
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <a href={`/marketplace/${profile.id}`} target="_blank"
                  className="flex items-center gap-1 text-purple-500 hover:opacity-80 transition text-xs font-semibold">
                        ...
                        <div className="flex items-start justify-between gap-2 mb-1">
                          ...
                          <div className="hidden sm:flex items-center gap-1.5 shrink-0">
                            ...
                            <button onClick={() => setEditId(listing.id)}
                              className="p-1.5 rounded-lg border border-gray-400/20 text-[var(--muted)] hover:text-purple-500 hover:border-purple-600/50 transition">
