...
function Section({ id, number, title, children }: {
  ...
  return (
    <section id={id} className="scroll-mt-24">
      <div className="flex items-center gap-3 mb-4 pb-3 border-b border-[var(--brand-purple)]/25">
        <span className="text-xs font-bold text-purple-600 bg-purple-600/10 border border-purple-600/30 px-2.5 py-1 rounded-full shrink-0">
          {number}
        </span>
        <h2 className="text-[var(--foreground)] font-bold text-lg sm:text-xl">{title}</h2>
      </div>
      <div className="space-y-3 text-[var(--muted)] leading-relaxed text-sm sm:text-base">
        {children}
      </div>
    </section>
  );
...
function SubSection({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div className="mt-5">
      <h3 className="text-[var(--foreground)] font-semibold text-sm sm:text-base mb-2">{title}</h3>
...
function Ul({ items }: { items: string[] }) {
  return (
    <ul className="space-y-1.5 mt-2">
      {items.map((item, i) => (
        <li key={i} className="flex items-start gap-2.5 text-[var(--muted)]">
...
const TOC_ITEMS = [
  ...
  { id: "marketplace",    number: "05", title: "Noizy Marketplace — Vendors & Listings" },
  ...
  { id: "notifications",  number: "14", title: "Notifications & Communications" },
  { id: "liability",      number: "15", title: "Limitation of Liability" },
  { id: "indemnification",number: "16", title: "Indemnification" },
  { id: "termination",    number: "17", title: "Account Suspension & Termination" },
  { id: "modifications",  number: "18", title: "Modifications to These Terms" },
  { id: "governing-law",  number: "19", title: "Governing Law & Dispute Resolution" },
    ...
    <div className="min-h-screen pt-20 pb-16">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center gap-2 bg-purple-600/10 border border-purple-600/30 text-purple-400 text-xs font-semibold px-3 py-1.5 rounded-full mb-4">
            <FileText className="w-3.5 h-3.5" />
            Legal Document
          </div>
          <h1 className="text-3xl sm:text-4xl font-black text-[var(--foreground)] mb-3">
            Terms & Conditions
          </h1>
          <div className="flex items-center justify-center gap-1 flex-wrap text-sm sm:text-base text-[var(--muted)]">
            <span>Effective Date: <span className="text-[var(--foreground)]">March 2026</span></span>
            <span className="mx-2 opacity-30">·</span>
            <span>Last Updated: <span className="text-[var(--foreground)]">March 2026</span></span>
          </div>
          <div className="mt-6 bg-purple-600/10 border border-purple-600/25 rounded-2xl p-4 max-w-2xl mx-auto">
            <p className="text-[var(--foreground)] text-sm leading-relaxed">
              Please read these Terms carefully before using our platform. By accessing or using Noizy Hub, you agree to be bound by these Terms.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          <aside className="lg:sticky lg:top-24 w-full lg:w-64 shrink-0">
            <div className="bg-gray-900 border border-gray-400/20 rounded-2xl p-4">
              ...
              <nav className="space-y-0.5 max-h-[60vh] overflow-y-auto pr-1">
                {TOC_ITEMS.map(item => (
                  <a
                    key={item.id}
                    href={`#${item.id}`}
                    className="flex items-center gap-2 px-2 py-1.5 rounded-lg text-xs text-[var(--muted)] hover:text-[var(--foreground)] hover:bg-white/5 transition group"
                  >
                    <span className="text-purple-600 font-mono shrink-0">{item.number}</span>
            ...
            {/* Download */}
            <div className="mt-4 bg-gray-900 border border-gray-400/20 rounded-2xl p-4">
              <p className="text-[var(--muted)] text-xs mb-2">Need a copy?</p>
              <a
                href="/terms/NoizyHub-Terms-and-Conditions.pdf"
                download
                className="flex items-center gap-2 text-purple-600 hover:opacity-80 text-xs font-semibold transition"
              >
                <FileText className="w-3.5 h-3.5" />
                Download .pdf
          ...
          <main className="flex-1 space-y-10 min-w-0">
            ...
            <Section id="introduction" number="01" title="Introduction">
              <P>Welcome to Noizy Hub, an online events marketplace operated in Kenya. Noizy Hub connects event organisers with attendees through seamless event discovery and ticketing, and brings together buyers and vendors through Noizy Marketplace — a space where vendors can list their services, products, and offerings to reach a wider audience. We also facilitate vending slot applications at events, enabling vendors to showcase their businesses at live events across Kenya.</P>
              <P>These Terms and Conditions ("Terms") govern your access to and use of the Noizy Hub website, mobile application, and all related services (collectively, the "Platform"). By registering an account or using any part of our Platform, you confirm that you have read, understood, and agree to these Terms.</P>
            ...
            <Section id="eligibility" number="03" title="Eligibility">
              ...
              <P>By using the Platform, you represent and warrant that you meet all of the above eligibility requirements. Noizy Hub reserves the right to suspend or terminate any account that does not meet these requirements.</P>
            </Section>

            <Section id="account" number="04" title="Account Registration & Security">
              <P>To access most features of the Platform, you must create an account. When registering, you agree to:</P>
              <Ul items={[
              ...
              <P>Noizy Hub reserves the right to refuse registration, suspend, or permanently terminate accounts at our sole discretion, particularly where we suspect fraud, misrepresentation, or violation of these Terms.</P>
            </Section>

            <Section id="marketplace" number="05" title="Noizy Marketplace — Vendors & Listings">
              <SubSection title="5.1 Becoming a Vendor on Noizy Marketplace">
                <P>Any registered User may apply to become a Vendor by creating a Marketplace Profile. By creating a profile, you represent that:</P>
                <Ul items={[
              ...
              <SubSection title="5.2 Listing Requirements">
                ...
                <P>Noizy Hub reserves the right to remove any Listing that violates these requirements without notice.</P>
              </SubSection>
              <SubSection title="5.3 Bookings & Transactions">
                <P>When a Buyer submits a Booking request to a Vendor, the following process applies:</P>
                <Ul items={[
                ...
                <P>Noizy Hub acts as a technology platform facilitating transactions between Buyers and Vendors. We are not a party to any transaction and are not responsible for the quality, safety, legality, or delivery of any goods or services.</P>
              </SubSection>
              <SubSection title="5.4 Platform Fee">
                <P>Noizy Hub charges a platform fee of 5% on all transactions processed through the Platform. This fee is automatically deducted from the Vendor's earnings before crediting the Vendor's Wallet. The remaining 95% is credited to the Vendor's Wallet upon successful payment confirmation.</P>
              </SubSection>
            ...
            <Section id="events" number="06" title="Events & Ticketing">
              ...
              <SubSection title="6.2 Ticket Purchases">
                <P>By purchasing a ticket through Noizy Hub, you acknowledge and agree that:</P>
                <Ul items={[
            ...
            <Section id="payments" number="07" title="Payments & Financial Terms">
              <P>All payments on Noizy Hub are processed in Kenyan Shillings (KES) via M-Pesa, facilitated through our payment partner IntaSend. By making a payment on the Platform, you agree that:</P>
              <Ul items={[
              ...
              <P>All prices displayed on the Platform are inclusive of applicable taxes unless stated otherwise.</P>
            </Section>

            <Section id="messaging" number="08" title="Messaging & Communications">
              <P>Noizy Hub provides an in-platform messaging system enabling Buyers to communicate with Vendors regarding Listings and Bookings. By using our messaging system, you agree to:</P>
              <Ul items={[
              ...
              <P>Noizy Hub retains message records for security, dispute resolution, and platform improvement purposes. All messages are accessible to both the sender and recipient at any time through the Platform.</P>
            </Section>
            ...
            <Section id="prohibited" number="09" title="Prohibited Conduct">
              ...
              <P>Violation of these prohibitions may result in immediate account suspension, permanent ban, and/or referral to law enforcement authorities.</P>
            </Section>

            <Section id="cancellations" number="10" title="Cancellations & Refunds">
              ...
              <SubSection title="10.3 Disputes">
                <P>In the event of a dispute between a Buyer and a Vendor, Noizy Hub encourages parties to resolve the matter through our in-platform messaging system. If resolution cannot be reached, either party may escalate the dispute to Noizy Hub by emailing noizyhub@gmail.com. Our decision is final and binding.</P>
              </SubSection>
            </Section>

            <Section id="deliveries" number="11" title="Deliveries">
              <P>Noizy Hub offers delivery services for purchases made through the Platform. The following terms apply:</P>
              <Ul items={[
            ...
            <Section id="ip" number="12" title="Intellectual Property">
              <P>All intellectual property rights in and to the Noizy Hub Platform, including but not limited to the name, logo, design, software, content, and trademarks, are owned by or licensed to Noizy Hub. You are granted a limited, non-exclusive, non-transferable licence to access and use the Platform for personal or business purposes in accordance with these Terms.</P>
              <P>By uploading content to the Platform (including product images, descriptions, and profile information), you grant Noizy Hub a worldwide, royalty-free licence to use, display, and distribute such content for the purpose of operating and promoting the Platform.</P>
              <P>You must not copy, reproduce, redistribute, or create derivative works of any Noizy Hub content without our prior written consent.</P>
            </Section>

            <Section id="privacy" number="13" title="Privacy & Data Protection">
              <P>Noizy Hub collects personal data including your name, email address, phone number, and payment-related information in order to provide our services. We are committed to protecting your privacy in accordance with Kenya's Data Protection Act, 2019.</P>
              <Ul items={[
            ...
            <Section id="notifications" number="14" title="Notifications & Communications">
              ...
              <P>Transactional notifications such as payment confirmations cannot be disabled as they are essential to the operation of the service.</P>
            </Section>

            <Section id="liability" number="15" title="Limitation of Liability">
              <P>To the fullest extent permitted by applicable Kenyan law, Noizy Hub shall not be liable for:</P>
              <Ul items={[
              ...
              <P>Noizy Hub's total aggregate liability to you for any claim shall not exceed the total amount you paid to Noizy Hub in the three (3) months preceding the event giving rise to the claim.</P>
            </Section>

            <Section id="indemnification" number="16" title="Indemnification">
              <P>You agree to indemnify, defend, and hold harmless Noizy Hub, its officers, employees, agents, and partners from and against any claims, liabilities, damages, losses, and expenses (including legal fees) arising out of or in connection with:</P>
              <Ul items={[
            ...
            <Section id="termination" number="17" title="Account Suspension & Termination">
              <P>Noizy Hub reserves the right to suspend or permanently terminate your account at any time, with or without notice, for reasons including but not limited to:</P>
              <Ul items={[
              ...
              <P>Upon termination, your right to access the Platform ceases immediately. Any outstanding Wallet balance will be processed for withdrawal subject to verification.</P>
              <P>You may delete your account at any time by contacting us at noizyhub@gmail.com. Deletion does not affect obligations arising from transactions completed prior to deletion.</P>
            </Section>

            <Section id="modifications" number="18" title="Modifications to These Terms">
              <P>Noizy Hub reserves the right to update or modify these Terms at any time. We will notify you of material changes by posting the updated Terms on the Platform and, where appropriate, by sending a notification to your registered email address. Your continued use of the Platform after such notification constitutes your acceptance of the revised Terms.</P>
              <P>We encourage you to review these Terms periodically to stay informed of any updates.</P>
            </Section>

            <Section id="governing-law" number="19" title="Governing Law & Dispute Resolution">
              <P>These Terms shall be governed by and construed in accordance with the laws of the Republic of Kenya. Any dispute arising out of or in connection with these Terms shall first be subject to good-faith negotiation between the parties. If resolution cannot be reached, the dispute shall be referred to mediation or, failing that, to the courts of Kenya.</P>
            </Section>
            ...
            <Section id="contact" number="20" title="Contact Us">
              ...
              <div className="mt-4 bg-gray-900 border border-gray-400/20 rounded-2xl p-5 space-y-3">
                <p className="text-[var(--foreground)] font-bold text-lg">Noizy Hub Kenya</p>
                <div className="flex items-center gap-3 text-sm">
                  <Mail className="w-4 h-4 text-purple-600 shrink-0" />
                  <a href="mailto:noizyhub@gmail.com" className="text-purple-600 hover:opacity-80 transition">
                    noizyhub@gmail.com
                  </a>
                </div>
                <div className="flex items-center gap-3 text-sm">
                  <Phone className="w-4 h-4 text-purple-600 shrink-0" />
                  <a href="tel:+254742422990" className="text-[var(--foreground)] hover:opacity-80 transition">
            ...
            {/* Closing note */}
            <div className="border-t border-[var(--brand-purple)]/25 pt-8 text-center space-y-2">
              <p className="text-[var(--muted)] text-sm italic">
                By using the Noizy Hub Platform, you acknowledge that you have read, understood, and agree to be bound by these Terms and Conditions.
              </p>
